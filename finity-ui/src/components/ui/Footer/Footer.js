        ...
        <footer className="pt-3 pb-3 footer">
            <div className="container">
                ...
                <div className="col-12 col-md-4">
                    ...
                    <h1 className="heading h6 text-uppercase font-weight-700 mb-3"><strong>Finity</strong></h1>
                    </div>
                </div>
                <div className="col-6 col-md">
                    <h5 className="heading h6 text-uppercase font-weight-700 mb-3">Features</h5>
                ...
                <div className="col-6 col-md">
                    <h5 className="heading h6 text-uppercase font-weight-700 mb-3">About</h5>
                    <ul className="list-unstyled text-small">
                ...
                <span className>
                    © 2020 <a href="/" className="footer-link" target="_blank">Finity</a>. All rights reserved.
                </span>
